...
const TalentCard = (props: any) => {
    ...
    return (
        <div className="bg-mine-shaft-900 p-4 w-[480.2px] hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400 flex flex-col gap-3 rounded-xl">
            ...
            {
                props.invited ?
                    <div className="flex gap-1 text-sm text-mine-shaft-200 items-center">
            ...
            <div className="flex [&>*]:w-1/2 [&>*]:p-1">
            {
                ...
                <>
                    ...
                    <div>
                        {props.posted ? <Button onClick={open} rightSection={<IconCalendarMonth className="w-5 h-5" />} color="bright-sun.4" fullWidth variant="light">Schedule</Button> : <Button color="bright-sun.4" fullWidth variant="light">Connect</Button>}
                    </div>
                </>
            }
            {
